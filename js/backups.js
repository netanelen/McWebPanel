                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == "nowriteraiz") {
                            ...
                            document.getElementById("textobackupretorno").innerHTML = "<div class='alert alert-danger' role='alert'>Error: La carpeta del servidor minecraft no tiene permisos de escritura.</div>";
                        } else if (data == "tarnoexiste") {
                            document.getElementById("textobackupretorno").innerHTML = "<div class='alert alert-success' role='alert'>Error: El backup seleccionado no existe.</div>";
                        } else if (data == "tarnolectura") {
                            document.getElementById("textobackupretorno").innerHTML = "<div class='alert alert-success' role='alert'>Error: El backup seleccionado no se puede leer.</div>";
                        } else if (data == "noborrado") {
                            document.getElementById("textobackupretorno").innerHTML = "<div class='alert alert-success' role='alert'>Error: La carpeta del servidor minecraft no se pudo borrar.</div>";
                            ...
                            document.getElementById("textobackupretorno").innerHTML = "<div class='alert alert-danger' role='alert'>Error: No se ha podido restaurar el servidor.</div>";
                        }
                    }
                });
            }
