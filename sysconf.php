                        ...
                        <div class="mt-3 col-md-6">
                            <div class="card border-left-primary shadow h-100">
                                <div class="card-body">
                                    ...
                                    <!-- Page Heading -->
                                    <h1 class="h2 text-gray-800 pt-2 mb-4">System Config</h1>
                                    <?php
                                    ...
                                    <form id="formconf" action="function/guardasysconf.php" method="post">
                                        <p>Seleccione Servidor Minecraft:</p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="<?php echo $recpuerto; ?>" class="form-control" id="elport" name="elport" required="required" min="1025" max="65535"></div>
